          ...
          <section style={{ padding: '20px' }}>
            ...
            {step === 1 && (
              <Box>
                ...
                <Box sx={{ 
                  ...
                  {['Cola', 'Orange', 'Lemon', 'Grape', 'Water', 'Coffee', 'Tea', 'Energy', 'Sprite'].map((flavorName) => (
                    <Button key={flavorName}
                      variant={flavor === flavorName ? 'contained' : 'outlined'}
                      onClick={() => setFlavor(flavorName)}
                      sx={buttonStyle}>
                      {flavorName}
                    </Button>
                  ))}
            ...
            {step === 2 && (
              <Box sx={{ display: 'grid', gap: 3, maxWidth: '600px', margin: '0 auto' }}>
                ...
                <Button variant={waterQuantity === '600' ? 'contained' : 'outlined'}
                  onClick={() => setWaterQuantity('600')}
                  sx={buttonStyle}>
                  600 ml
                </Button>
              </Box>
